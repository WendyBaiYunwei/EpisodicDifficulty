...
parser.add_argument("-n","--name",type=str,default='51-mini-cl')
    ...
    for episode in range(EPISODE):
        ...
        if episode == 0 or (episode + 1)%10000 == 0:
            ...
            if test_accuracy > last_accuracy:
                # save networks
                print("save networks for episode:",episode,'difficulty level:',sampler.difficulty_level)
        ...
        if sampler.order_on and (episode + 1)%INTERVAL == 0:
            ...
            print('difficulty_level increases to: ', sampler.difficulty_level)
